...
class _YouthScreenState extends State<YouthScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final canScout =
        save.budget >= scoutCost && prospects.length < maxProspects;

    final candidates = gameState.scoutCandidates
            ...
            for (final p in candidates)
              Padding(
                ...
                child: Card(
                  child: ListTile(
                    leading:
                        PlayerFaceAvatar(playerId: p.id, position: p.position),
                    title: Row(
                      children: [
                        Flexible(
                            child:
              ...
              Padding(
                ...
                child: Card(
                  child: ListTile(
                    ...
                    subtitle:
                        Text('${p.age}歳 / 総合 ${p.overall} / 潜在 ${p.potential}'),
                    trailing: Row(
